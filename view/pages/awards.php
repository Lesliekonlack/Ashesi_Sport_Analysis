...
// Fetch players with trophies associated with the team
$trophies = [];
try {
    $sql = "
        SELECT t.*, p.Name as PlayerName, p.Image as PlayerImage, p.Nationality as PlayerNationality
        FROM trophies t
    ...
    echo 'Error fetching trophies: ' . $e->getMessage();
    exit();
}
...
<head>
    <meta charset="UTF-8">
    <title><?php echo htmlspecialchars($team_name); ?> Awards - Ashesi Sports Insight</title>
...
>>>>>>> 7fc77fe751335c9d00fa4cc04ed52a94444bed78
            <li><a href="team_stories.php?team_id=<?php echo htmlspecialchars($team_id); ?>">Team Stories</a></li>
        </ul>
    </div>
    <div class="main-content">
        <section class="section">
            <h2>Awards and Trophies of Gotten By Players Of <?php echo htmlspecialchars($team_name); ?></h2>
            <div class="awards-container">
                <?php if (empty($trophies)): ?>
                    <p>No trophies have been awarded to players of this team.</p>
                <?php else: ?>
                    <?php foreach ($trophies as $trophy): ?>
                        <div class="award-card">
                            <div class="player-image">
                                <img src="<?php echo htmlspecialchars(getPlayerImagePath($trophy['PlayerImage'])); ?>" alt="<?php echo htmlspecialchars($trophy['PlayerName']); ?>">
                            </div>
                            <div class="award-info">
                                <h3><?php echo htmlspecialchars($trophy['PlayerName']); ?></h3>
                                <p><?php echo htmlspecialchars($trophy['Name']); ?> (<?php echo htmlspecialchars($trophy['Year']); ?>)</p>
                                <p><?php echo htmlspecialchars($trophy['Description']); ?></p>
                                <p><?php echo htmlspecialchars($trophy['PlayerNationality']); ?></p>
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
